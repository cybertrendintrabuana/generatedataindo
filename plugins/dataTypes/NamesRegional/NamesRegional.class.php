...
class DataType_NamesRegional extends DataTypePlugin {
	...
	private $regionalNames = array(
		...
		"indonesia" => array(
			"firstNamesFemale" => array(
				"Angel", "Anna","Ayumi", "Azizah", "Bella", "Bianca", "Bonita", "Cindy", "Cinta", "Cantik", "Desi", "Dita", "Dona", "Eli", "Emilia", "Erika", "Farah", "Fika", "Fitri", "Gigi", "Gina", "Gita", "Hamidah", "Hana", "Hani", "Indah", "Intan", "Ira",
