...
$L["no_data"] = "Nothing to generate! Enter some data to be generated.";
...
$L["row_sp"] = "Row(s)";
$L["save_uc"] = "SAVE";
$L["script_thinking"] = "Hold on for a second. The script is thinking.";
...
$L["installation_intro"] = "Enter your database information to create your database tables. If you're unsure about any of these fields, click on the Help tab for a little more info.";
$L["version"] = "Version";
...
$L["help_prereq_info"] = "You need to have already created a database before running the installation script. <i>The installation script doesn't create the database, it just tries to connect to it to create the tables.</i> If you're not sure how to create a database within your environment, you'll either need to contact your hosting provider, or spend some time researching it on Google. Sorry!";
...
$L["about_title"] = "About";
$L["about_para1"] = "Sometimes you need dummy data for things like testing software, populating databases and creating realistic-looking mockups. For text, we have <i>lorem ipsum</i>; but for everything else...? This tool was written to provide a quick and simple way to let you generate large volumes of custom data in whatever format you require.";
$L["about_para2"] = "The <b>Generate</b> page contains the entire script: just fill in the various fields in the page to construct the data set you're interested in, then click the Generate button.";
...
$L["export_type_validate_error"] = "There was an error in the Export Type's validate() function. Sorry, we can't proceed - call a developer!";
$L["close"] = "Close";
...
$L["installation_step2_intro"] = "Click the button below to create your <b>settings.php</b> file. This file is stored in the root folder of this application and is the only place (other than the database) that stores custom information about your installation.";
...
$L["success"] = "success";
$L["error"] = "error";
$L["invalid_password"] = "Password is incorrect. Please try again.";
